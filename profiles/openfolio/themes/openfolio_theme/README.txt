...
OpenFolio Theme is a stater sub-theme for Corolla 7.x-2.x and can be easily
...
name from OpenFolio Theme, then read on.

1. Copy this entire theme and change the name of the folder. Currently the name of the folder
   is "openfolio_theme", so you might choose "bartheme". In the next step we will use this name for
...
2. openfolio_theme.info - first rename this file to match the folder name you chose in step one. Next you
...
4. template.php - open up this file and make some changes - search and replace "openfolio_theme" for your
   themes name.

   In openfolio_theme_preprocess_html() you will find some stuff about responsive stylesheets and IE conditional
