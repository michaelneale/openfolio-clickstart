...
/* Original databases entry in default settings.php

$databases = array();

*/

/* What localhost usage will look like after initialization
...
/* For manual deployment to CloudBees using -as bindings
...
/* For ClickStart deployment on CloudBees */

$databases['default']['default'] = array(
    'driver' => 'mysql',
    'database' => getenv('MYSQL_DB_DRUPAL'),
